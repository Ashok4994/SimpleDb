...
public class TupleDesc {
	...
	public static TupleDesc combine(TupleDesc td1, TupleDesc td2) {
		simpledb.Type[] newTypes = new simpledb.Type[td1.numFields() + td2.numFields()];
	 ...
	 */
	public TupleDesc(simpledb.Type[] typeAr, String[] fieldAr) {
		types = typeAr;
		names = fieldAr;
	}
	 ...
	 *            entry.
	 */
	public TupleDesc(simpledb.Type[] typeAr) {
		types = typeAr;
	 ...
	 *             if i is not a valid field reference.
	 */
	public simpledb.Type getType(int i) throws NoSuchElementException {
		// some code goes here
